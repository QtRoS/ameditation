    ...
    Pane {
        ...
        Flickable {
            ...
            Column {
                ...
                Label {
                    text: "Для прослушивания медитаций предпочтительно использовать наушники.<br><br>\
Выберите медитацию из списка. Обязательно прочтите аннотацию. Включите запись. \
Когда услышите голос, настройте громкость кнопками вашего устройства.<br><br>Позаботьтесь о том, \
...
о высокой степени расслабления, что хорошо, вне сомнений.<br><br>\
<font color='red'>Запрещено прослушивать медитации во время ответственной \
деятельности: вождение автомобиля, работа на сложном оборудовании и т.п. </font><br><br>\
